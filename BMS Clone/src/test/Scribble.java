...
public class Scribble extends Applet implements ActionListener, AdjustmentListener, MouseListener, MouseMotionListener
{
 ...
 private int mousex                = 0; 	/* Current mouse coordinates */
 ...
 private boolean initialLine       = true;			 /* Initial state falgs for operation */
 ...
 private int  Orx                  = 0;
 private int  Ory                  = 0;
 private int  OrWidth              = 0;				/* Main Mouse X and Y coordiante variables */
